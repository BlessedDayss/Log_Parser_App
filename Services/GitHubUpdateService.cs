namespace Log_Parser_App.Services
{
    ...
    public class GitHubUpdateService : IUpdateService
    {
        ...
        public async Task<string> DownloadUpdateAsync(UpdateInfo updateInfo, IProgress<int>? progressCallback = null) {
            ...
            _logger.LogInformation("Starting download: Version={Version}, URL={Url}", updateInfo.Version, updateInfo.DownloadUrl);
            ...
            try {
                ...
                string fileName = $"update-{updateInfo.Version}.zip";
        ...
        public async Task<bool> InstallUpdateAsync(string updateFilePath) {
            try {
                ...
                string extractPath = Path.Combine(_tempFolder, "extract");
                ...
                string sourceDir = directories.Length > 0 ? directories[0] : extractPath;
                ...
                _logger.LogInformation("Detected platform: Windows={isWindows}, macOS={isMacOS}, Linux={isLinux}", isWindows, isMacOs, isLinux);
...
echo ""Update completed at $(date)""";
        ...
        private async Task<GitHubTestResult> TestGitHubConnectionAsync() {
            try {
                ...
                var releases = JsonSerializer.Deserialize<List<GitHubReleaseInfo>>(content, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
